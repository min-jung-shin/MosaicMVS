...
CAMERA_MODELS = {
    ...
    CameraModel(model_id=6, model_nam12),
    CameraModel(model_id=7, model_name="FOV", num_params=5),e="FULL_OPENCV", num_params=
    ...
    with open(path_to_model_file, "rb") as fid:
        ...
        for point_line_index in range(num_points):
            ...
            points3D[point3D_id] = Point3D(
                ...
                error=error, image_ids=image_ids,
                point2D_idxs=point2D_idxs) #dictio
    return points3D
...
def processing_single_scene(args):
    ...
    for i in range(len(images)):
        ...
        view_sel.append([(k, score[i, k]) for k in sorted_score[:24]])
    print('view_sel[0]\n', view_sel[0], end='\n\n')
...
if __name__ == '__main__':
    ...
    # --dense_folder N:\Dataset\mvs_training\dtu\Rectified_colmap\scan1_train --save_folder N:\Dataset\mvs_training\dtu\scan1_c2m
    # --dense_folder E:\Dataset_bck2\XZ_dataset_5\images_resized_COLMAP\group04 --save_folder E:\Dataset_bck2\XZ_dataset_5\images_resized_COLMAP_MVSNET\group04